...
def configure_sensor(i2c: I2C) -> None:
    ...
    print("Initial integration bits:", hex(sensor.integration_time))
    print("Initial measurement rate bits:", hex(sensor.measurement_rate))
    print("Initial gain bits:", hex(sensor.gain))
    ...
    print("Updated integration bits:", hex(sensor.integration_time))
    ...
    print("Updated gain bits:", hex(sensor.gain))
    ...
    print("Demonstrating reset() call followed by enable()")
    sensor.reset()
    sensor.enable(color_mode=True)
...
def main() -> None:
    ...
    try:
        ...
        print("Sensor reported an error:", exc)
